        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <span id="status-span" class="text-xs font-semibold px-3 py-1 rounded-full
        ...
        @if(in_array($commnande->status, [\App\Models\Commnande::STATUT_PAYEE, \App\Models\Commnande::STATUT_EN_ATTENTE]))
            <div class="mt-6">
                <button id="confirm-btn"
                    data-url="{{ route('commnandes.confirm', $commnande->id) }}"
...
<!-- Inclusion du JS -->
<script src="{{ asset('js/commande-detail.js') }}"></script>
@endsection
