...
<div class="bg-white border rounded-lg p-4 shadow-sm">
    <div class="flex items-center">
        <div class="rounded-full w-12 h-12 bg-red-100 text-red-600 flex items-center justify-center mr-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">
                @php
                    ...
                    $nbAvis = $evaluations->count();
                    $moyenneNote = $nbAvis > 0 ? $evaluations->avg('note') : 0;
                @endphp
